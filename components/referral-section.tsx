  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Share Trickipedia with friends and earn referral points when they sign
          up!
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="text-sm text-muted-foreground">
          <p>
            When someone signs up using your referral link, your referral count
            increases. Share your link on social media, with friends, or in your
            community to help grow the Trickipedia database!
          </p>
        </div>
      </CardContent>
    </Card>
